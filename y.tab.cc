...
{
       0,    93,    93,    97,    98,   102,   123,   124,   128,   136,
     143,   144,   148,   157,   165,   179,   192,   200,   211,   212,
...
static const char *const yytname[] =
{
  ...
  "NEWLINE", "PIPE", "LESS", "TWOGREAT", "GREATAMPERSAND", "GREATGREAT",
  "GREATGREATAMPERSAND", "$accept", "goal", "command_list", "argument",
  "arg_list", "command_word", "cmd_and_args", "pipe_list", "io_modifier",
  "io_modifier_list", "background_opt", "command_line", "simple_command", YY_NULLPTR
};
#endif
...
static const yytype_int8 yypact[] =
{
      ...
      -6,    -6,    -6,    -6,    12,    15,    -5,    -6,    -6,    -6,
      -6,    16,    17,    18,    19,    20,    21,    -6,    22,    -6,
      -6,    -6,    -6,    -6,    -6,    -6
};
...
{
       0,     0,     8,    24,     0,     0,     7,    10,    19,     3,
      22,    25,     1,     4,     9,     0,    21,     5,     6,    11,
      20,     0,     0,     0,     0,     0,     0,    18,     0,    13,
      17,    16,    15,    12,    14,    23
};
...
{
      20,    21,    12,    11,    22,    23,    24,    25,    26,    -2,
       1,     1,     2,     2,    15,    17,     3,     3,     2,    29,
      30,    31,    32,    33,    34,     0,    19,     0,    13,    35
};
...
{
       0,     1,     3,     7,    15,    16,    19,    20,    21,    25,
      26,     7,     0,    25,    18,     8,    23,     3,    17,    20,
       5,     6,     9,    10,    11,    12,    13,    22,    24,     3,
       3,     3,     3,     3,     3,     7
};
...
#line 102 "shell.y"
    ...
    if (strchr((yyvsp[0].cpp_string)->c_str(), '?') == NULL && strchr((yyvsp[0].cpp_string)->c_str(), '*') == NULL) {
